...
中文 | [English](https://github.com/htell1347-prog/ZenlessZoneZero-Signal-Export/blob/master/docs/README_EN.md)
...
修改`src/i18n/`目录下的 json 文件就可以翻译到对应的语言。因为翻译结果是使用DeepSeek V4 Pro进行翻译，觉得已有的翻译有不准确或可以改进的地方，可以随时修改发 Pull Request。
